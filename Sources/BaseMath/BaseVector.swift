...
extension SupportsBasicMath {
  ...
  @inlinable public static func sqr(_ n:Int, _ pSrc:PtrT, _ pDst:MutPtrT) { for i in 0..<n { pDst[i] = pSrc[i].sqr() } }
...
extension BaseVector {
  ...
  @inlinable public func sumfabs()->Element { return Element.sumfabs(p, numericCast(c)) }
  ...
  @inlinable public func sqr(_ dest:Self) { Element.sqr(count, self.p, dest.p) }
